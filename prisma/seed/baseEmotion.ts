...
const BASE_EMOTIONS = [
  { name: "Joie", emoji: "😊", color: "#FBBF24", score: 5 },
  { name: "Colère", emoji: "😠", color: "#EF4444", score: 2 },
  { name: "Peur", emoji: "😨", color: "#8B5CF6", score: 2 },
  { name: "Tristesse", emoji: "😢", color: "#3B82F6", score: 1 },
  { name: "Surprise", emoji: "😮", color: "#F59E0B", score: 4 },
  { name: "Dégoût", emoji: "🤢", color: "#6B7280", score: 1 },
];
